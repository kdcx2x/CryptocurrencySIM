    ...
    <header>
      ...
      <nav>
        <ul>
          ...
          <li><a class="active"href="invest.php">Invest</a></li>
        </ul>
      </nav>
    </header>
    <div class="note">
...
<div class="container1">
  ...
  <div class="words" style="left: 380px;">
    Coins
  </div>
...
<script>
  $(document).ready(function(){
    ...
    $(".crytpoBitcoin").click(function(){
      $.post("invest_hphandle.php",{"type":1,"crypo":"Bitcoin"})
      .done(function(data){
    ...
    $(".cryptoLitcoin").click(function(){
        ...
        $.post("invest_hphandle.php",{"type":1,"crypo":"Litecoin"})
        .done(function(data){
    ...
    $(".cryptoEthereum").click(function(){
        ...
        $.post("invest_hphandle.php",{"type":1,"crypo":"Ethereum"})
        .done(function(data){
    ...
    $(".crytpoCash").click(function(){
        ...
        $.post("invest_hphandle.php",{"type":1,"crypo":"BitcoinCash"})
        .done(function(data){
...
// $('#coins').val(coins);
      ...
      if(plus==0){
        alert("plus")
        $.post("invest_handle.php",{"type":0,"crypo":crytpo,"bPrice":bprice,"spent":spent})
        .done(function(data){
          console.log(data);
          if(data=="good"){
            alert("good");
